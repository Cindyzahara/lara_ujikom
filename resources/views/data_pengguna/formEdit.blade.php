            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pd-10 pd-sm-20 bg-gray-100">
                        {{-- untuk mengirimkan data pengguna ke endpoint atau route 'data_pengguna.update' menggunakan metode HTTP POST. 
                        Atribut enctype menunjukkan bahwa formulir ini dapat mengandung data file (misalnya, untuk mengunggah gambar). --}}
                        <form action="{{ route('data_pengguna.update', $data->id) }}" method="post" enctype="multipart/form-data">
                        @csrf 
                        {{-- adalah helper function yang digunakan dalam formulir HTML Laravel untuk menentukan bahwa metode HTTP yang akan digunakan untuk mengirim
                        formulir adalah PUT. Ini sering digunakan dalam konteks formulir yang digunakan untuk memperbarui data di server. --}}
                        @method('PUT') 
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
