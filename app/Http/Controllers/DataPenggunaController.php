...
class DataPenggunaController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if ($namerole === 'administrator') {
            $isrole = 1; // kalo isi dari var namerole administrator
        } else {
            $isrole = 2; // kalo bukan ini
        }
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            // Sintkas untuk memberi tahu proses berhasil 
            return redirect()
            ->route('data_pengguna')
            ->with('success', 'Data berhasil dihapus');
        }
        catch(Exception $e){
            // Sintaks untuk memberi tahu eror 
			return back()
            ->withInput()
            ->with('error','Gagal memproses!');
		}
    ...
    public function import_excel(Request $request)
    {
        ...
        //VALIDATION FORM
        //untuk memvalidasi data yang dimasukan oleh pengguna sesuai kriteria sebelum masuk ke proses selanjutnya 
        $request->validate([
        ...
        try {
            if($file){
                ...
                // Sintaks untuk memberitahu eror
                return back()
                ->withInput()
                ->with('error','Gagal memproses!');
            }
